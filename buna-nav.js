...
(function(){
 ...
 style.textContent=`#buna-nav{background:#1a1a1a;position:sticky;top:0;z-index:999;width:100%}#buna-nav-inner{max-width:1100px;margin:0 auto;display:flex;overflow-x:auto;scrollbar-width:none;align-items:center}#buna-nav-inner::-webkit-scrollbar{display:none}#buna-nav a{color:rgba(255,255,255,.55);text-decoration:none;font-family:'Segoe UI',-apple-system,BlinkMacSystemFont,sans-serif;font-size:.78em;font-weight:600;letter-spacing:.04em;padding:13px 16px;white-space:nowrap;border-bottom:2px solid transparent;transition:color .15s,border-color .15s;display:block}#buna-nav a:hover{color:#fff;border-bottom-color:rgba(255,255,255,.3)}#buna-nav a.buna-nav-home{color:#d4c5c0;border-right:1px solid rgba(255,255,255,.12);padding-right:18px;margin-right:4px}#buna-nav a.buna-nav-active{color:#fff;border-bottom-color:#d4c5c0}#buna-nav a.buna-nav-vocab{color:rgba(160,200,160,.8);margin-left:auto;border-left:1px solid rgba(255,255,255,.1)}#buna-nav a.buna-nav-vocab:hover{color:#a0d0a0}@media(max-width:600px){#buna-nav a{font-size:.72em;padding:12px 12px}}`;
